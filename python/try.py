...
def main():
    ...
    image_width, image_height = 711, 639
    yaw, roll, pitch = 60.869, -49.4783, -3.29358
    tx, ty, scale = 170.454, 97.5417, 2.30562
    affine_camera_matrix = [yaw, roll, pitch, tx, ty, scale]
    pca_shape_coefficients = [-0.0379799,0.559008,0.602648,-0.152,0.21687, -0.759703,0.769095,
