...
int main(int argc, char* argv[])
{
    ...
    auto eosPath = std::string("/Users/huangliang/Documents/eos/examples/");
    
    {
        modelfile = eosPath + std::string("../share/sfm_shape_3448.bin");
        blendshapesfile = eosPath + std::string("../share/expression_blendshapes_3448.bin");
        outputbasename = eosPath + std::string("out");
    }
